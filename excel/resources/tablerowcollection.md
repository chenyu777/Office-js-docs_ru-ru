...
|:---------------|:--------|:----------|
|[add(index: number, values: (boolean, string или number)[][])](#addindex-number-values-boolean-or-string-or-number)|[TableRow](tablerow.md)|Добавляет новую строку в таблицу.|
