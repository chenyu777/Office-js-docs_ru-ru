...
|[getBoundingRect(anotherRange: Range или string)](#getboundingrectanotherrange-range-or-string)|[Range](range.md)|Возвращает наименьший объект диапазона, включающий в себя заданные диапазоны. Например, getBoundingRect для "B2:C5" и "D10:E15" возвращает значение "B2:E15".|
...
|[getIntersection(anotherRange: Range или string)](#getintersectionanotherrange-range-or-string)|[Range](range.md)|Возвращает объект диапазона, представляющий собой прямоугольное пересечение заданных диапазонов.|
