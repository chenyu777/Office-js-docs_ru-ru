# Объект ChartAxisFormat (API JavaScript для Excel)
...
| Связь | Тип|Описание|
|:---------------|:--------|:----------|
|font|[ChartFont](chartfont.md)|Представляет атрибуты шрифта (имя, размер, цвет и т. д.) элемента оси диаграммы. Только для чтения.|
