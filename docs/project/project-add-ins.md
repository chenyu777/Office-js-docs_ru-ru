...
Общие сведения о надстройках Office см. в статье [Обзор платформы надстроек Office](../../docs/overview/office-add-ins.md).
...
## Разработка надстроек для Project
...
### Создание файла манифеста надстройки
...
### Процедура 1. Создание файла манифеста для надстройки поиска Bing


- Создайте XML-файл в локальном каталоге. Этот XML-файл включает в себя элемент  **OfficeApp** и дочерние элементы, описанные в статье [XML-манифест надстроек для Office](../../docs/overview/add-in-manifests.md). Например, создайте файл BingSearch.xml со следующим XML-кодом.
...
### Процедура 2. Установка надстройки поиска Bing
...
6. В области  **Надежные каталоги надстроек** (см. рис. 1) добавьте путь `\\ServerName\AppManifests` в текстовое поле **URL-адрес каталога**, выберите элемент  **Добавить каталог** и нажмите кнопку **ОК**.
    ...
    **Рис. 1. Добавление каталогов с манифестами надстроек с помощью центра управления безопасностью**
    ...
    ![Добавление манифестов приложений с помощью центра управления безопасностью](../../images/pj15_AgaveOverview_TrustCenter.PNG)
...
**Рис. 3. Использование надстройки поиска Bing**
