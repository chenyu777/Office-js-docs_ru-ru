...
- Предоставлять свое описание через идентификатор, версию, описание, отображаемое имя и языковой стандарт по умолчанию.
...
Примеры представлены в статье [Примеры XML-файлов манифеста версии 1.1](#примеры-xml-файлов-манифеста-версии-1.1).

## Обязательные элементы


В приведенной ниже таблице представлены обязательные элементы для надстроек Office трех типов.


 >**Важные примечания**: 
 - Все URL-адреса, например расположения исходных файлов, указанные в элементе [SourceLocation](../../reference/manifest/sourcelocation.md), должны быть защищены **SSL-шифрованием (HTTPS)**.
 - Все URL-адреса значков, например для командных зон, должны **поддерживать кэширование**. Веб-сервер НЕ должен возвращать заголовки HTTP, например no-cache или no-store. 
 - Надстройки, отправляемые в Магазин Office, также должны включать элемент [SupportUrl](../../reference/manifest/supporturl.md). Дополнительные сведения см. в разделе [Каких распространенных ошибок отправки следует избегать?](http://msdn.microsoft.com/library/0ceb385c-a608-40cc-8314-78e39d6c75d0%28Office.15%29.aspx#bk_q2)


**Обязательные элементы по типам надстроек Office**


|**Элемент**|**Контент**|**Область задач**|**Outlook**|
|:-----|:-----|:-----|:-----|
|[элемент OfficeApp](http://msdn.microsoft.com/en-us/library/68f1cada-66f8-4341-45f5-14e0634c24fb%28Office.15%29.aspx)|X|X|X|
|[Id](http://msdn.microsoft.com/en-us/library/67c4344a-935c-09d6-1282-55ee61a2838b%28Office.15%29.aspx)|X|X|X|
|[Версия](http://msdn.microsoft.com/en-us/library/6a8bbaa5-ee8c-6824-4aba-cb1a804269f6%28Office.15%29.aspx)|X|X|X|
...
|[Описание](http://msdn.microsoft.com/en-us/library/bcce6bad-23d0-7631-7d8c-1064b8453b5a%28Office.15%29.aspx)|X|X|X|
...
* Добавлено в схеме манифеста приложения для Office версии 1.1.


## Примеры и схемы XML-файлов манифестов версии 1.1


В следующих разделах приведены примеры XML-файлов манифеста версии 1.1 для надстроек области задач, контентных надстроек и надстроек Outlook.

### Пример манифеста версии 1.1 для надстройки Office с командами и резервной областью задач
[Схема манифеста для надстройки области задач](https://github.com/OfficeDev/office-js-docs/tree/master/docs/overview/schemas/taskpane)
...
### Пример манифеста версии 1.1 для контентной надстройки
[Схема манифеста надстройки](https://github.com/OfficeDev/office-js-docs/tree/master/docs/overview/schemas/content)
...
### Пример манифеста версии 1.1 для надстройки Outlook
[Схема манифеста надстройки](https://github.com/OfficeDev/office-js-docs/tree/master/docs/overview/schemas/mail)
...
## Проверка манифеста надстроек Office


Чтобы убедиться, что файл манифеста, описывающий вашу надстройку Office, содержит правильные и исчерпывающие сведения, сверьте его с [файлами определения схемы XML (XSD)](https://github.com/OfficeDev/office-js-docs/tree/master/docs/overview/schemas). Для проверки манифеста можно воспользоваться средством проверки схем XML или Visual Studio. Кроме того, вы можете скачать [пакет совместимости приложений Office](https://www.microsoft.com/en-us/download/details.aspx?id=46831) и запустить его в надстройке.

Сведения о сверке манифеста со схемой см. в статье [Средство проверки схем XML (XSD)](http://stackoverflow.com/questions/124865/xml-schema-xsd-validation-tool).


## Указание доменов, которые необходимо открыть в окне надстройки


По умолчанию, если надстройка пытается перейти на URL-адрес в домене, отличном от домена, где размещена начальная страница (указан в элементе [SourceLocation](http://msdn.microsoft.com/en-us/library/00d95bb0-e8f5-647f-790a-0aa3aabc8141%28Office.15%29.aspx) файла манифеста), этот URL-адрес откроется в новом окне браузера, а не в области надстроек ведущего приложения Office. Это поведение по умолчанию защищает пользователя от непредвиденной навигации по страницам в области надстроек из-за встроенных элементов **iframe**.

Чтобы переопределить это поведение, добавьте каждый домен, который требуется открыть в окне надстройки, в список доменов в элементе [AppDomains](http://msdn.microsoft.com/en-us/library/13cf867d-9b24-786f-0687-6bcdc954628e%28Office.15%29.aspx) файла манифеста. Если надстройка пытается перейти по URL-адресу домена, не входящего в список, то страница откроется в новом окне браузера (не в области надстроек).
...
- [Определение команд надстройки в манифесте](../../docs/outlook/manifests/define-add-in-commands.md)
- [Указание ведущих приложений Office и требований к API](../../docs/overview/specify-office-hosts-and-api-requirements.md)
- [Локализация надстроек Office](../../docs/develop/localization.md)
- [Справка по схемам манифестов надстроек Office](https://github.com/OfficeDev/office-js-docs/tree/master/docs/overview/schemas)
