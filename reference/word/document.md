...
| Связь | Тип   |Описание|
|:---------------|:--------|:----------|
|Основной текст|[Body](body.md)|Возвращает основной текст документа. Основной текст — это текст, не содержащий верхних и нижних колонтитулов, сносок, текстовых полей и т. д. Только для чтения.|
...
|разделы|[SectionCollection](sectioncollection.md)|Возвращает коллекцию объектов разделов в документе. Только для чтения.|
