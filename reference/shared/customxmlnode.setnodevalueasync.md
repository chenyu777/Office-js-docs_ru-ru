...
# Метод CustomXmlNode.setNodeValueAsync
Асинхронно задает значение узла.
...
|**[Добавлено](#Добавлено) в версии**|1.1|
...
|:-----|:-----|:-----|:-----|
| _value_|**string**|Значение, задаваемое текущему узлу. Обязательный параметр.||
...
В функции обратного вызова, переданной в метод **setNodeValueAsync**, можно использовать свойства объекта **AsyncResult**, чтобы возвратить такие сведения:
