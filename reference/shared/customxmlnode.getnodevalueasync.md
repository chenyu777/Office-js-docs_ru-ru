...
# Метод CustomXmlNode.getNodeValueAsync
Асинхронно получает значение узла.
...
В функции обратного вызова, переданной в метод **getNodeValueAsync**, можно использовать свойства объекта **AsyncResult**, чтобы возвратить следующие сведения:



|**Свойство**|**Применение**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Получает доступ к строке **string**, содержащей значение указанного узла.|
