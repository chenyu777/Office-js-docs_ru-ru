...
# Свойство Binding.document
Получает объект **Document**, связанный с привязкой.
...
|1.1|Добавлена поддержка привязки таблиц при записи табличных данных в надстройках для Access.|
|1.0|Представлено|
