...
# Свойство CustomXmlNode.namespaceUri
Получает GUID строки [CustomXMLPart](../../reference/shared/customxmlpart.customxmlpart.md).
...
GUID настраиваемой XML-части в виде **string**.
