...
# Метод CustomXmlPart.deleteAsync
Асинхронно удаляет настраиваемую XML-часть из коллекции.
...
В функции обратного вызова, переданной методу **deleteAsync**, вы можете использовать свойства объекта **AsyncResult**, чтобы получить следующие сведения:
