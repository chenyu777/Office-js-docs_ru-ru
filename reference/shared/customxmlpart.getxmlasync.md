...
# Метод CustomXmlPart.getXmlAsync
...
|**Свойство**|**Применение**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Получает доступ к значению типа **string**, содержащему код XML указанного объекта [CustomXmlPart](../../reference/shared/customxmlnode.getnodesasync.md).|
