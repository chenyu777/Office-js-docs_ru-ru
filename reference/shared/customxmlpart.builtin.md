...
# Свойство CustomXmlPart.builtIn
Получает значение, указывающее, является ли объект CustomXMLPart встроенным.
 ...
 **true**, если настраиваемая XML-часть является встроенной; в противном случае **false**.
