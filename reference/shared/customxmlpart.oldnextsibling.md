...
# Свойство NodeDeletedEventArgs.oldNextSibling
Получает следующий одноуровневый узел для узла, который был только что удален из объекта **CustomXMLPart**.
...
Объект [CustomXmlNode](../../reference/shared/customxmlnode.customxmlnode.md), представляющий следующий одноуровневый узел удаленного узла.
