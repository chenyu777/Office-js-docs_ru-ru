...
# Метод CustomXmlNode.getNodesAsync
Получает узлы в виде массива объектов **CustomXMLNode**, соответствующих связанному выражению XPath.
...
|:-----|:-----|:-----|:-----|
| _xPath_|**string**|Выражение XPath, определяющее получаемые узлы. Обязательный.||
...
В функции обратного вызова, переданной методу **getNodesAsync**, вы можете использовать свойства объекта **AsyncResult**, чтобы получить следующие сведения:



|**Свойство**|**Применение**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Получает доступ к **массиву** объектов [CustomXMLNode](../../reference/shared/customxmlnode.customxmlnode.md), представляющих узлы, указанные выражением XPath, которое было передано в параметр _xPath_.|
