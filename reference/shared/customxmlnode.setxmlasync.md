...
# Метод CustomXmlNode.setXmlAsync
Задает XML узла.
...
|:-----|:-----|:-----|:-----|
| _XML_|**string**|XML для добавляемого поддерева. Обязательный параметр.||
...
В функции обратного вызова, переданной в метод **setXmlAsync**, можно использовать свойства объекта **AsyncResult**, чтобы возвратить такие сведения:
